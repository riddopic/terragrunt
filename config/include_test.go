...
func TestDeepMergeConfigIntoIncludedConfig(t *testing.T) {
	...
	testCases := []struct {
		...
		// Deep merge dependency blocks: simple concat
		{
			"dependency concat",
			&TerragruntConfig{
				TerragruntDependencies: []Dependency{
					Dependency{Name: "vpc", ConfigPath: "../vpc"},
					Dependency{Name: "mysql", ConfigPath: "../mysql"},
				},
			},
			&TerragruntConfig{
				TerragruntDependencies: []Dependency{
					Dependency{Name: "security", ConfigPath: "../baseline"},
				},
			},
			&TerragruntConfig{
				TerragruntDependencies: []Dependency{
		...
		// Deep merge dependency blocks: deep override for same name blocks
		{
			"dependency same block",
			&TerragruntConfig{
				TerragruntDependencies: []Dependency{
					Dependency{
						Name:        "vpc",
						MockOutputs: mapToCty(t, overrideMap),
					},
				},
			},
			&TerragruntConfig{
				TerragruntDependencies: []Dependency{
					Dependency{
						Name:        "vpc",
						MockOutputs: mapToCty(t, originalMap),
					},
				},
			},
			&TerragruntConfig{
				TerragruntDependencies: []Dependency{
					Dependency{
						Name:        "vpc",
						MockOutputs: mapToCty(t, mergedMap),
					},
				},
			},
		},
